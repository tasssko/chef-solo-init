...
mkdir -p $LOCAL_PATH/archives $LOCAL_PATH/sources $LOCAL_PATH/cookbooks

#which cookbooks do we need ?
get_cookbook "chef-apache2" $LOCAL_PATH $COOKBOOK_PATH $LOCAL_PATH/cookbooks
get_cookbook "chef-php5" $LOCAL_PATH $COOKBOOK_PATH $LOCAL_PATH/cookbooks
get_cookbook "chef-mysql" $LOCAL_PATH $COOKBOOK_PATH $LOCAL_PATH/cookbooks
get_cookbook "chef-skystack" $LOCAL_PATH $COOKBOOK_PATH $LOCAL_PATH/cookbooks
get_cookbook "chef-collectd" $LOCAL_PATH $COOKBOOK_PATH $LOCAL_PATH/cookbooks
